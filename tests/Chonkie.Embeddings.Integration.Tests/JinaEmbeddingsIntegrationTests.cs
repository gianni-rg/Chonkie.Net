...
/// <summary>
/// Integration tests for Jina embeddings provider
/// These tests require JINA_API_KEY environment variable to be set
/// </summary>
public class JinaEmbeddingsIntegrationTests
{
    ...
    public async Task EmbedAsync_WithRealAPI_ReturnsValidEmbedding()
    {
        ...
        var embeddings = new JinaEmbeddings(apiKey: apiKey);
    ...
    public async Task EmbedAsync_WithCustomModel_ReturnsValidEmbedding()
    {
        // Arrange
        var apiKey = TestHelpers.GetEnvironmentVariableOrSkip(ApiKeyEnvVar);
        var embeddings = new JinaEmbeddings(apiKey: apiKey, model: "jina-embeddings-v2-base-en");

@echo off
REM Docker Compose → Podman Compose wrapper for Visual Studio
REM This batch file wraps Podman compose to act as docker-compose.exe
...
REM Execute podman compose with all arguments
"%PODMAN_PATH%" compose %*
exit /b %ERRORLEVEL%
